...
public class Select {
    public void selectStudent(String chooseString) throws SQLException {
    ...
    public void selectSubject(String chooseString) throws SQLException {
        SubjectDao subjectDao = new SubjectDao();
        switch (chooseString) {
            case "1.2.1":
    ...
    public void selectTeacher(String chooseString) throws SQLException {
